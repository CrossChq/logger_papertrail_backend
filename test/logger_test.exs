defmodule LoggerPapertrailBackend.LoggerTest do
  ...
  setup do
    ...
    on_exit(fn ->
      LoggerBackends.remove(LoggerPapertrailBackend.Logger, flush: true)
      Application.delete_env(:logger, :logger_papertrail_backend)
    end)
  ...
  defp config(opts) do
    LoggerBackends.configure(LoggerPapertrailBackend.Logger, opts)
  end
end
